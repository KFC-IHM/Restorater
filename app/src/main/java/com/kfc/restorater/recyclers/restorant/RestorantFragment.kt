...
import com.kfc.restorater.recyclers.restorant.placeholder.PlaceholderContent
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyRestorantRecyclerViewAdapter(PlaceholderContent.ITEMS)
            }
        }
        return view
    }
